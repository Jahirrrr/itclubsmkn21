...
class NewPostModal extends React.Component {
    ...
    displayModal = () => {
        if (this.state.tab === 'text') {
            ...
            return <VideoPostModal updateView={this.props.updateView} setModal={this.props.setModal} selectedGroup={this.state.selectedGroup} />;
            ...
            <div className='newPostModal' ref={this.wrapperRef}>
                ...
                <div id='postTypeTab'>
                    <ul>
                        ...
                        <li><button className={this.state.tab === 'video' ? 'selectedTab' : ''} onClick={() => this.setState({ tab: 'video' })}>VIDEO</button></li>
